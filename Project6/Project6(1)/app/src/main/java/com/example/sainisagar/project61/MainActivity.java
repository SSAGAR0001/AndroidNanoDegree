...
{
    private static final String NEWS_URL = "https://content.guardianapis.com/search?q=debate&tag=politics/politics&from-date=2014-01-01&api-key=test";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter1(this, news);
    ...
    private void refresh() {
        if (isNetworkConnected()) {
            ...
            text.setText(R.string.not_connected);
    ...
    public static class ListLoader extends AsyncTaskLoader<ArrayList<News>> {
        ...
        public ArrayList<News> loadInBackground() {
            ...
            return FetchData.News(NEWS_URL);
        }
    }
